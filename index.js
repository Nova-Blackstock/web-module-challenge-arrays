...
function removeFlavorByName(arr, badflav){
    arr.splice('badflav', 1);
    console.log(arr);
    /*code here*/
}
...
copy(originalFlavors, 'betterflavors')
...
function filterByWord(arr, string, filteredArray){
    filteredArray = [];
...
return filteredArray;   /*code here*/
}
filterByWord(originalFlavors, "Chocolate", 'filteredArray')
